...
import { exportMessagePublicKeyJwk, importMessagePublicKeyJwk, importPublicKeyJwk } from './keys';
import type {
...
export async function encryptDirectMessage(
  ...
  const ephemeralKeys = await crypto.subtle.generateKey(ECDH_ALGORITHM, true, ['deriveKey']);
