...
export function assertOpenSocialNetworkFollowList(
  value: unknown,
): asserts value is OpenSocialNetworkFollowList {
  if (!isOpenSocialNetworkFollowList(value)) {
    throw new Error('Follow list is not a valid Open Social Network follow list');
  }
}
